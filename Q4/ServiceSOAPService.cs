...
[System.Web.Services.WebServiceBindingAttribute(Name="IServiceSOAPPortBinding", Namespace="http://localhost:8080")]
public partial class ServiceSOAPService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    
    private System.Threading.SendOrPostCallback sayHelloOperationCompleted;
    
    /// CodeRemarks
    public ServiceSOAPService() {
        this.Url = "http://localhost:8080/WSSOAP/ServiceSOAPService";
    }
